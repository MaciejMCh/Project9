...
private:
	...
	glObjectFactory* mObjectFactory;
	SceneFeaturesFactory* mSceneFeaturesFactory;

	std::vector<glObjectDraw* > mObjects;
	std::vector<SceneFeature* > mSceneFeatures;
